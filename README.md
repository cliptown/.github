# cliptown organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`cliptown`](https://github.com/cliptown).

## Canonical organization links

- GitHub organization: https://github.com/cliptown
- Public organization defaults: https://github.com/cliptown/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomcliptown-adf62fab3f42
...
`cliptown` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
